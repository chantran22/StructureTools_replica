...
**Add reactions/ reaction table** - Code from **buildsmart888 (Structure Tools - Enhance ) (https://github.com/buildsmart888/StructureTools-Enhanced)** - to show /retrieve reaction value at supports location
